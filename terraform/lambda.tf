resource "aws_lambda_function" "example" {
   ...
   s3_bucket = "terraform-serverless-example-learnhashicorp"
...
# The special path_part value "{proxy+}" activates proxy behavior, which means that this resource will match 
# any request path. Similarly, the aws_api_gateway_method block uses a http_method of "ANY", 
# which allows any request method to be used. Taken together, this means that all incoming requests will 
# match this resource.
